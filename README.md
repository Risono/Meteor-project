...
2021/9/2
　AppStoreとGooglePlayでの配信を再開しました。(Ver.1.0.3)
　広告なしでも問題なくプレイできます^^

　なお、広告アカウント停止について、わかる限り調査・対応（広告表示方法の修正）しましたが、Googleから再開不可の回答がきました。理由を教えてもらえないので、不本意ながらAdMob広告への対応は終します。

2021/8/22
　何かの理由でGoogleから広告アカウントを停止されています。原因調査と対応のため現在、AppStoreとGooglePlayでの配信を停止します。対応でき次第配信を再開します。
